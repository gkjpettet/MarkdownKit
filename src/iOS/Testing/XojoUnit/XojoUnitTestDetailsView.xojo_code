...
Begin iosView XojoUnitTestDetailsView
   ...
   Begin iOSLabel Label11
      ...
      Width           =   294.0
   End
   Begin iOSRectangle TestResultsRectangle
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   TestResultsRectangle, 2, Rectangle1, 2, False, +1.00, 1, 1, 0, , True
      AutoLayout      =   TestResultsRectangle, 3, Label11, 4, False, +1.00, 1, 1, *kStdControlGapV, , True
      AutoLayout      =   TestResultsRectangle, 1, <Parent>, 1, False, +1.00, 1, 1, 20, , True
      AutoLayout      =   TestResultsRectangle, 8, , 0, False, +1.00, 1, 1, 370, , True
      BorderColor     =   &c00000000
      BorderWidth     =   2.0
      CornerHeight    =   0.0
      CornerWidth     =   0.0
      ...
      Begin iOSLabel TestNameLabel
         ...
         AutoLayout      =   TestNameLabel, 1, TestResultsRectangle, 1, False, +1.00, 4, 1, *kStdControlGapH, , True
         AutoLayout      =   TestNameLabel, 3, TestResultsRectangle, 3, False, +1.00, 1, 1, *kStdGapCtlToViewV, , True
         AutoLayout      =   TestNameLabel, 7, , 0, False, +1.00, 1, 1, 190, , True
         Enabled         =   True
         Height          =   30.0
         InitialParent   =   "TestResultsRectangle"
         Left            =   28
         LineBreakMode   =   "0"
         LockedInPosition=   False
         PanelIndex      =   0
         Parent          =   "TestResultsRectangle"
         Scope           =   0
         Text            =   "Test Name"
         TextAlignment   =   "0"
         TextColor       =   &c00000000
      ...
      Begin iOSLabel TestResultLabel
         ...
         AutoLayout      =   TestResultLabel, 1, TestResultsActual, 1, False, +1.00, 4, 1, 0, , True
      ...
      Begin iOSLabel Label13
         ...
         AutoLayout      =   Label13, 1, TestResultsRectangle, 1, False, +1.00, 1, 1, *kStdControlGapH, , True
      ...
      Begin iOSLabel TestDurationLabel
         ...
         AutoLayout      =   TestDurationLabel, 2, TestResultsRectangle, 2, False, +1.00, 1, 1, -*kStdControlGapH, , True
         Enabled         =   True
         Height          =   30.0
         InitialParent   =   "TestResultsRectangle"
         Left            =   111
         ...
         Width           =   885.0
      End
      Begin iOSLabel LabelExpected
         AccessibilityHint=   ""
         AccessibilityLabel=   ""
         AutoLayout      =   LabelExpected, 8, , 0, False, +1.00, 1, 1, 30, , True
         AutoLayout      =   LabelExpected, 1, TestResultsRectangle, 1, False, +1.00, 1, 1, *kStdControlGapH, , True
         AutoLayout      =   LabelExpected, 3, TestDurationLabel, 4, False, +1.00, 1, 1, *kStdControlGapV, , True
         AutoLayout      =   LabelExpected, 7, , 0, False, +1.00, 1, 1, 100, , True
         Enabled         =   True
         Height          =   30.0
         InitialParent   =   "TestResultsRectangle"
         Left            =   28
         ...
         Width           =   100.0
      End
      Begin iOSLabel LabelActual
         AccessibilityHint=   ""
         AccessibilityLabel=   ""
         AutoLayout      =   LabelActual, 10, LabelExpected, 10, False, +1.00, 4, 1, , , True
         AutoLayout      =   LabelActual, 8, , 0, False, +1.00, 4, 1, 30, , True
         AutoLayout      =   LabelActual, 1, TestResultsExpected, 2, False, +1.00, 4, 1, *kStdControlGapH, , True
         AutoLayout      =   LabelActual, 7, , 0, False, +1.00, 4, 1, 100, , True
         Enabled         =   True
         Height          =   30.0
         Left            =   516
         LineBreakMode   =   "0"
   ...
   Begin iOSProgressWheel ProgressWheel1
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   ProgressWheel1, 2, TestResultsRectangle, 2, False, +1.00, 4, 1, 0, , True
      ...
      Width           =   24.0
   End
   Begin iOSTextArea TestResultsActual
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   TestResultsActual, 4, TestResultsRectangle, 4, False, +1.00, 4, 1, -20, , True
      AutoLayout      =   TestResultsActual, 1, TestResultsExpected, 2, False, +1.00, 4, 1, *kStdControlGapH, , True
      AutoLayout      =   TestResultsActual, 2, TestResultsRectangle, 2, False, +1.00, 4, 1, -*kStdControlGapH, , True
      AutoLayout      =   TestResultsActual, 3, LabelActual, 4, False, +1.00, 4, 1, *kStdControlGapV, , True
      Editable        =   True
      Height          =   216.0
      KeyboardType    =   "0"
      Left            =   516
      ...
      Width           =   480.0
   End
   Begin iOSTextArea TestResultsExpected
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   TestResultsExpected, 4, TestResultsRectangle, 4, False, +1.00, 4, 1, -*kStdControlGapV, , True
      AutoLayout      =   TestResultsExpected, 1, TestResultsRectangle, 1, False, +1.00, 4, 1, *kStdControlGapH, , True
      AutoLayout      =   TestResultsExpected, 3, LabelExpected, 4, False, +1.00, 4, 1, *kStdControlGapV, , True
      AutoLayout      =   TestResultsExpected, 7, TestResultsActual, 7, False, +1.00, 4, 1, 0, , True
      Editable        =   True
      Height          =   228.0
      KeyboardType    =   "0"
      Left            =   28
