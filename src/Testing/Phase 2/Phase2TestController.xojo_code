#tag Class
Protected Class Phase2TestController
Inherits TestController
	...
	#tag Method, Flags = &h0
		Shared Function GetTestAST(fileName As Text, ByRef ast As Text) As Boolean
		  ...
		  Dim f As Xojo.IO.FolderItem = Xojo.IO.SpecialFolder.GetResource("phase 2 ASTs").Child(fileName)
	...
	#tag Method, Flags = &h0
		Shared Sub RunPhase2Test(methodName As Text, tg As TestGroup)
		  ...
		  Dim astNAme As Text = Phase1TestController.GetTestNumberFromMethodName(methodName) + "-phase2.ast"
		  ...
		  // Create a new Markdown document and parse it.
