...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Function GetTestNumberFromTestName(testName As String) As String
		  ...
		  Var startPos As Integer = testName.IndexOf("Example") + 7
		  Var chars() As String = testName.Split("")
	...
	#tag Method, Flags = &h21
		Private Sub ResetTestGroupList()
		  ...
		  lastRow = TestGroupList.SelectedRowIndex - 1
		  For row As Integer = lastRow DownTo 0
	...
	#tag Method, Flags = &h21
		Private Sub UpdateTestSummary()
		  ...
		  Try
		    ...
		    Var testNumber As String = GetTestNumberFromTestName(name)
		    // Read the contents of the file containing the input Markdown for 
		    // this test and assign it to the relevant text area.
		    Var md As String
...
#tag Events TestGroupList
	...
	#tag Event
		Function CellTextPaint(g As Graphics, row As Integer, column As Integer, x as Integer, y as Integer) As Boolean
		  ...
		  If Me.CellValueAt(row, ColResult) = TestResult.Failed Then
